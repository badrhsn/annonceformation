...
public class OAuth2AccessTokenResponseConverterWithDefaults implements Converter<Map<String, String>, OAuth2AccessTokenResponse>, org.springframework.core.convert.converter.Converter<Map<String, String>, OAuth2AccessTokenResponse> {
